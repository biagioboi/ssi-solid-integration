...
const {ConnectionEventTypes, DidExchangeState} = require("@aries-framework/core");
...
function middleware (accountManager) {
  ...
  router.get(['/register', '/api/accounts/new'], restrictToTopDomain, CreateAccountRequest.get)
    ...
    router.post('/api/accounts/ssi-new', bodyParser, (req, res) => {
      ...
      //CreateAccountRequest.post_ssi(req, res).then(r => console.log(r))
      /*res.status(200).json({
        test: "test"
      })*/
          ...
          const credentialOffer = {
            ...
            credentialFormats: {
              anoncreds:{
                ...
                //credentialDefinitionId: "did:indy:bcovrin:test:S9BtNBg9dLGv2T26iTBWtZ/anoncreds/v0/CLAIM_DEF/257965/default",
                attributes: [
                  { mimeType:'text/plain', name: 'webid', value: 'test' }
                ],
              },
            },
          }
